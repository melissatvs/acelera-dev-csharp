...
{
    public partial class codenationx : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_submission_challenge_id_user_id", x => new { x.challenge_id, x.user_id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_candidate_acceleration_id_company_id_user_id", x => new { x.acceleration_id, x.company_id, x.user_id });
                    table.ForeignKey(
